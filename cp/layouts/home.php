        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">فروش محصولات</h4>
                </div>
                <div class="card-body">
                    <div class="card-block">
                        <div class="chart-info mb-3 ml-3">
                            <span class="gradient-blackberry d-inline-block rounded-circle mr-1" style="width:15px; height:15px;"></span> فروش
                            <span class="gradient-mint d-inline-block rounded-circle mr-1 ml-2" style="width:15px; height:15px;"></span> بازدید
                        </div>
        ...
        <div class="col-xl-4 col-lg-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="font-medium-2 text-muted text-center pb-2">6 ماه گذشته </p>
