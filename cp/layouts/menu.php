<div data-active-color="white" data-background-color="black" data-image="app-assets/img/sidebar-bg/01.jpg" class="app-sidebar">
    ...
    <div class="sidebar-header">
        <div class="logo clearfix">
            <a href="index-2.html" class="logo-text float-left">
                ...
                <span class="text align-middle">ARSHITAWEB</span>
            </a><a id="sidebarToggle" href="javascript:;" class="nav-toggle d-none d-sm-none d-md-none d-lg-block">
    ...
    <!-- / main menu header-->
    <!-- main menu content-->
    <div class="sidebar-content ps-container ps-theme-default" data-ps-id="cc748b27-089d-dc35-de7d-a0de5694c7c5">
        <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                <li class="nav-item">
                    <a href="#">
                        <i class="ft-home"></i>
                        <span data-i18n="" class="menu-title">میزکار</span>
                    </a>
