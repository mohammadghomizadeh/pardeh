                     ...
                     <form class="form" method="POST" action="index.php?page=portfolio/edit" enctype="multipart/form-data">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<input id="portfolio_title" class="form-control" value="<?php echo $redit['title']; ?>" name="portfolio_title" type="text">
								</div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="uploads/products/<?php echo $redit['image1']; ?>" id="portfolio_img1" height="100" width="150">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="uploads/products/<?php echo $redit['image2']; ?>" id="portfolio_img2" height="100" width="150">
            </div>
            <script type="text/javascript">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="uploads/products/<?php echo $redit['image3']; ?>" id="portfolio_img3" height="100" width="150">
            </div>
            <script type="text/javascript">
        ...
        <hr>
			<div class="form-group">
					...
					<textarea id="portfolio_description" rows="5" class="form-control" name="portfolio_description">
