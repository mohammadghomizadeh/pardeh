				...
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="_Content/images/d2.jpg">
							<div class="thumb-image"> <img src="_Content/images/d2.jpg" data-imagezoom="true" data-zoomviewposition="left" class="img-responsive"> </div>
						</li>
						<li data-thumb="_Content/images/d1.jpg">
							<div class="thumb-image"> <img src="_Content/images/d1.jpg" data-imagezoom="true" data-zoomviewposition="left" class="img-responsive"> </div>
						</li>	
						<li data-thumb="_Content/images/d3.jpg">
							<div class="thumb-image"> <img src="_Content/images/d3.jpg" data-imagezoom="true" data-zoomviewposition="left" class="img-responsive"> </div>
						</li>
					</ul>
					   ...
					   <div class="tab1">
							...
							<div class="single_page_agile_its_w3ls">
							  <h6>کفش اسپرت مردانه Garner</h6>
							   <p>کفش‌های Garner دارای کیفیت بسیار بالایی میباشند و کفش مذکور دارای رویه و جنس داخلی چرم طبیعی هستند.</p>
							   <p class="w3ls_para">جهت نگه‌داری از کالاهای تهیه شده از چرم، از واکس‌های غیر استاندارد استفاده نشود و حتی المکان در صورت سطح روی کفش، بلافاصله آن را تمیز نمایید.</p>
							</div>
						</div>
						<!--//tab_one-->
						<div class="tab2">
									...
									<div class="bootstrap-tab-text-grid">
										...
										<div class="bootstrap-tab-text-grid-right pull-left">
											<ul>
												...
												<li><a href="#"><i class="fa fa-reply-all" aria-hidden="true"></i> پاسخ</a></li>
											</ul>
											<p>با سلام و احترام و تشکر از سایت خوبتون لطفا با توجه به استقبال خوب از این برند، تنوع محصولات آن را افزایش دهید</p>
										</div>
										<div class="clearfix"> </div>‌
						             </div>
						   ...
						   <div class="tab3">
							...
							<div class="single_page_agile_its_w3ls">
							  <h6>نحوه انتخاب سایز مناسب</h6>
							   <p>از آنجا که قالب همه کفش ها یکسان نیست، پیدا کردن سایز مناسب به خصوص در خرید اینترنتی کفش، کمی سخت به نظر می رسد. بامیلو برای حل این مشکل، علاوه بر ارائه راهنمای اندازه گیری پا و انتخاب سایز، در قسمت ملاحظات محصول، بزرگی و کوچکی قالب کفش مورد نظر را آورده است تا انتخابی مطمئن تر را برای شما فراهم سازد. همچنین در صورت هر گونه مغایرت در سایز امکان بازگشت محصول به صورت رایگان برای شما وجود دارد.</p>
							   <p class="w3ls_para">توجه: در صورت تردید میان دو سایز، سایز بزرگ تر را انتخاب کنید، زیرا در نهایت می توانید از کفی اضافه استفاده کنید.</p>
							</div>
						</div>
					</div>
				</div>	
